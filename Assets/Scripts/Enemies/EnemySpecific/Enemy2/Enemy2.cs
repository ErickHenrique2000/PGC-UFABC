...
public class Enemy2 : Entity
{
    ...
    public override void Start()
    {
        ...
        meleeAttackState = new E2_MeleeAttackState(this, stateMachine, "meleeAttack", meleeAttackPoint, meleeAttackStateData, this);
        ...
        rangedAttackState = new E2_RangedAttackState(this, stateMachine, "rangedAttack", rangedAttackPoint,rangedAttackStateData, this);
